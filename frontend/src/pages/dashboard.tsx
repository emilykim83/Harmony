...
const Dashboard = () => {
  ...
  const [lessons, setLessons] = React.useState('Loading...');
  const [progress, setProgress] = React.useState('Loading...');
  const [sections, setSections] = React.useState('Loading...');
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiMusicNote || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiProgressCheck || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiViewList || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
