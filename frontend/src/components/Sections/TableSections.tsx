...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/sections/sectionsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureSectionsCols';
...
const TableSampleSections = ({
  ...
  useEffect(() => {
    if (sectionsNotify.showNotification) {
      notify(sectionsNotify.typeNotification, sectionsNotify.textNotification);
    }
  }, [sectionsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/sections/sections-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {sections && Array.isArray(sections) && !showGrid && (
        <ListSections
          sections={sections}
          loading={loading}
...
export default TableSampleSections;
