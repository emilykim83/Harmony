...
const ListSections = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_SECTIONS');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/sections/sections-edit/?id=${item.id}`}
                  pathView={`/sections/sections-view/?id=${item.id}`}
