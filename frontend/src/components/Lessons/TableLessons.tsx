...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/lessons/lessonsSlice';
...
const TableSampleLessons = ({
  ...
  const handleViewAction = (id: string) => {
    router.push(`/lessons/lessons-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {lessons && Array.isArray(lessons) && !showGrid && (
        <ListLessons
          lessons={lessons}
          loading={loading}
