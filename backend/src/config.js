...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '3e541b9ac65d1590b33a5a52560d4a76',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Harmony <app@flatlogic.app>',
  ...
  project_uuid: 'd38b743a-18e7-418a-ad44-fd624e81f28b',
  flHost:
...
config.pexelsQuery = 'children learning music happily';
config.host =
