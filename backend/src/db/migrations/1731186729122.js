module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('sections', 'lessonId', {
        transaction,
      });

      await queryInterface.removeColumn('sections', 'name', { transaction });

      await queryInterface.removeColumn('progress', 'completed_at', {
        transaction,
      });

      await queryInterface.removeColumn('progress', 'completed', {
        transaction,
      });

      await queryInterface.removeColumn('progress', 'sectionId', {
        transaction,
      });

      await queryInterface.removeColumn('progress', 'userId', { transaction });

      await queryInterface.removeColumn('lessons', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('lessons', 'title', { transaction });
